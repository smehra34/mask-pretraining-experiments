...
# Modes:
#   Main:     sbatch --export=ALL,RUN_MODE=main,TRAIN_TOKENS=100000000000 1B-meap-config.sh
#   Cooldown: sbatch --export=ALL,RUN_MODE=cooldown,SOURCE_ITER=2384,COOLDOWN_TOKENS=10000000000 1B-meap-config.sh
#
